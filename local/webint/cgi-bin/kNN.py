...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="#">Inference Rules Instances Viewer</a>
        </div>	
        <div class="navbar-collapse collapse">
<form action ="./kNN.py" method="GET" class="navbar-form navbar-right" role="form">

<div class="form-group">
<input class="form-control" name="query" placeholder="Predicate,Context,Slot,Argument" type="text" style="width:400px" value="%s" />
</div>
