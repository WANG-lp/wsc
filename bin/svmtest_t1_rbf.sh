...
# '~/src/svm_rank/svm_rank_learn -c $argv[2] -# 100 local/train.$fs.isv local/train.$fs.model.svmrank;'\
...
'echo ~/src/svm_rank/svm_rank_learn -t 2 -c '$argv[2]' -g '$argv[3]' -# 100 local/train.$fs.isv local/train.$fs.model.svmrank;'\
'~/src/svm_rank/svm_rank_learn -t 2 -c '$argv[2]' -g '$argv[3]' -# 100 local/train.$fs.isv local/train.$fs.model.svmrank;'\
'echo ;'\
