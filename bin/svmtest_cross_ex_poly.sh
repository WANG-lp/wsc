...
'echo ~/src/svm_rank/svm_rank_learn -t 1 -d 2 -c '$argv[2]' -# 100 local/train.$fs.isv local/train.$fs.model.svmrank;'\
'~/src/svm_rank/svm_rank_learn -t 1 -d 2 -c '$argv[2]' -# 100 local/train.$fs.isv local/train.$fs.model.svmrank;'\
'echo ;'\
